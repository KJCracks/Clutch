...
- (void)replaceBytesInRange:(NSRange)range withBytes:(const void *)bytes {
    [self performWithFileOffsetResetOffset:range.location block:^(NSFileHandle *__weak fh) {
...
- (void)getBytes:(void *)result atOffset:(const unsigned long long)offset length:(NSUInteger)length {
    [self performWithFileOffsetResetOffset:offset block:^(NSFileHandle *__weak fh) {
