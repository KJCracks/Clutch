...
- (NSDictionary *)listApplicationsForiOS8AndHigher {
    NSMutableDictionary<NSString *, Application *> *returnValue = [NSMutableDictionary new];
    LSApplicationWorkspace *applicationWorkspace = [LSApplicationWorkspace defaultWorkspace];

    NSArray<FBApplicationInfo *> *proxies = [applicationWorkspace allApplications];
    NSDictionary<NSString *, id> *bundleInfo = nil;
